    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DepartmebtID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Departments", x => x.DepartmebtID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Professors_Departments_DepatrmentId",
                        column: x => x.DepatrmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmebtID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Professors_DepatrmentId",
                table: "Professors",
                column: "DepatrmentId");
        }
